 ...
 * @author Acer
 */
public class StockDetailsView extends javax.swing.JFrame {
    ...
    public void setStockDetails(ResultSet rs) {
        tblStockDetails.setAutoResizeMode(tblStockDetails.AUTO_RESIZE_OFF);
        tblStockDetails.setModel(DbUtils.resultSetToTableModel(rs));
...
//      
        try {
            ...
            tblStockDetails.print(JTable.PrintMode.NORMAL, headerFormat, footerFormat);
...
//        new Dashboard().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StockDetailsView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockDetailsView().setVisible(true);
            }
        });
    }
