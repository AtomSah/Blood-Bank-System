...
LoginModel model;
    ...
    String Email = txtEmail.getText(); // Retrieve the string value from the text input field
    String password = txtPassword.getText();


    model = new LoginModel( txtEmail.getText(), txtPassword.getText());
    return model;
}
 ...
 public void addLoginListner(ActionListener log)
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 120, 160, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 102));
        jLabel2.setText("Blood Bank Management System");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, 600, 46));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 102));
        jLabel3.setText("Email");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 180, 110, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 102));
        jLabel4.setText("Password");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 230, 80, -1));
        ...
        getContentPane().add(btnLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 300, -1, 30));
        ...
        getContentPane().add(btnSignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 350, 170, 40));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 180, 260, -1));
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 230, 260, -1));
        ...
        getContentPane().add(btnExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 300, -1, 30));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 0, 102));
        jLabel6.setText("Donate Blood  ! Save Life !");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 470, 410, -1));
        ...
        getContentPane().add(txtClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 300, -1, 30));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/login2.png"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 50, 310, 550));
...
//                JOptionPane.showMessageDialog(null, "<html><b>Login Successful</b></html", "Message", JOptionPane.INFORMATION_MESSAGE, icon);
//                clear();
//
//            }
...
//        }
    ...
    public void setMessage(String login_Successfully) {
